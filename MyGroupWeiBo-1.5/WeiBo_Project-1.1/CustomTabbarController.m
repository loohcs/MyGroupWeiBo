...
- (void)initWithVCTitle
{
    ...
    BaseNavigationController *homeNaVC = [[BaseNavigationController alloc]initWithRootViewController:home];
    MessageViewController *message = [[MessageViewController alloc]init];
    
    BaseNavigationController *messageNaVC = [[BaseNavigationController alloc]initWithRootViewController:message];
    PersonalViewController *personal = [[PersonalViewController alloc]init];
    
    BaseNavigationController *profileNaVC = [[BaseNavigationController alloc]initWithRootViewController:personal];
    SquareViewController *square = [[SquareViewController alloc]init];
    
    BaseNavigationController *discoverNaVC = [[BaseNavigationController alloc]initWithRootViewController:square];
    MoreViewController *more = [[MoreViewController alloc]init];
    
    BaseNavigationController *moreNaVC = [[BaseNavigationController alloc]initWithRootViewController:more];
