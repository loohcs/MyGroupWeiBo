...
- (void)getCommentForWeibo:(NSString *)weiboID
{
    ...
    [WBHttpRequest requestWithAccessToken:[defaluts objectForKey:@"accessToken"] url:COMMENTS_SHOW httpMethod:@"GET" params:[NSDictionary dictionaryWithObjectsAndKeys:weiboID, @"id", @"20",@"count", nil] delegate:self];
}
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        float height = [WeiboCell getSize:_weiboContex] - 45.0f;
        return height;
    }
    else
    {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        [cellTest.retweetButton removeFromSuperview];
        [cellTest.commentButton removeFromSuperview];
        [cellTest.praiseButton removeFromSuperview];
