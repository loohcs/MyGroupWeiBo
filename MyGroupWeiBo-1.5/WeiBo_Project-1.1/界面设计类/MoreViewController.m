...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    if (section==4)
    {
        ...
        [btnOut addTarget:self action:@selector(logOutWeibo) forControlEvents:UIControlEventTouchUpInside];
...
- (void)logOutWeibo
{
    ...
    [WeiboSDK logOutWithToken:[defaults objectForKey:@"accessToken"] delegate:self];
